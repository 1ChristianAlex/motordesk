...
class YearTest {
    @Test fun `accepts current year`() = assertEquals(getCurrentUtcDateTime().year, Year(getCurrentUtcDateTime().year).value)
    @Test fun `rejects years before 1900 and in the future`() {
